...
import AppViewPage from "./appViewPage/NewAppViewPage";
import OldAppViewPage from "./appViewPage/AppViewPage";
    ...
    return (
      <div>
        ...
        <Switch>
          ...
          <Route path="/old-app-page" component={OldAppViewPage} />
          ...
          <Route path="/view/:id" component={AppViewPage} />{" "}
          {/* In the long run we will be using 
